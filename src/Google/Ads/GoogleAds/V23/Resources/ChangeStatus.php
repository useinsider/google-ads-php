...
class ChangeStatus extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ChangeStatusResourceTypeEnum\ChangeStatusResourceType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\ChangeStatusOperationEnum\ChangeStatusOperation::class);
