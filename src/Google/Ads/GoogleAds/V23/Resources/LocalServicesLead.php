...
class LocalServicesLead extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\LocalServicesLeadTypeEnum\LeadType::class);
        $this->lead_type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\LocalServicesLeadStatusEnum\LeadStatus::class);
