...
class CustomAudience extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\CustomAudienceStatusEnum\CustomAudienceStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V23\Enums\CustomAudienceTypeEnum\CustomAudienceType::class);
        $this->type = $var;
