...
class AdNetworkType
{
     ...
     * Discover feed, Gmail, YouTube. Starting with V23, Demand Gen Stats will
...
class_alias(AdNetworkType::class, \Google\Ads\GoogleAds\V23\Enums\AdNetworkTypeEnum_AdNetworkType::class);
