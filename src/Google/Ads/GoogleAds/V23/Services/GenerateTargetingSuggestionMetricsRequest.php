...
class GenerateTargetingSuggestionMetricsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.BasicInsightsAudience audiences = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $audiences;
    /**
     ...
     * @param \Google\Ads\GoogleAds\V23\Services\BasicInsightsAudience[] $audiences  Required. Audiences to request metrics for.
     *
     ...
     *           Required. The ID of the customer.
     *     @type array<\Google\Ads\GoogleAds\V23\Services\BasicInsightsAudience>|\Google\Protobuf\Internal\RepeatedField $audiences
     *           Required. Audiences to request metrics for.
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v23.services.BasicInsightsAudience audiences = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     * @param array<\Google\Ads\GoogleAds\V23\Services\BasicInsightsAudience>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setAudiences($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Services\BasicInsightsAudience::class);
        $this->audiences = $arr;
