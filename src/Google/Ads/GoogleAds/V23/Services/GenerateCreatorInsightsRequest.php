 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.GenerateCreatorInsightsRequest</code>
 */
class GenerateCreatorInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.common.AdditionalApplicationInfo insights_application_info = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     *           The sub-country geographic locations to search that apply to the criteria.
     *           Only supported for [SearchAttributes] criteria.
     *     @type \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchAttributes $search_attributes
     ...
     *     @type \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchBrand $search_brand
     *           A brand used to search for top creators. Data fetched is based on the
     *           list of countries specified in [country_locations].
     *     @type \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\YouTubeChannels $search_channels
     ...
     * [country_locations] or [sub_country_locations].
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchAttributes search_attributes = 3;</code>
     * @return \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchAttributes|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchAttributes search_attributes = 3;</code>
     * @param \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchAttributes $var
     * @return $this
     */
    public function setSearchAttributes($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchAttributes::class);
     ...
     * list of countries specified in [country_locations].
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchBrand search_brand = 5;</code>
     * @return \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchBrand|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchBrand search_brand = 5;</code>
     * @param \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchBrand $var
     * @return $this
     */
    public function setSearchBrand($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\SearchBrand::class);
     ...
     * based on the list of countries specified in [country_locations].
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.YouTubeChannels search_channels = 4;</code>
     * @return \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\YouTubeChannels|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.YouTubeChannels search_channels = 4;</code>
     * @param \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\YouTubeChannels $var
     * @return $this
     */
    public function setSearchChannels($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V23\Services\GenerateCreatorInsightsRequest\YouTubeChannels::class);
