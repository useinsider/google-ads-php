 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v23.services.SearchTopics</code>
 */
class SearchTopics extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Google\Ads\GoogleAds\V23\Common\AudienceInsightsEntity>|\Google\Protobuf\Internal\RepeatedField $entities
     *           Required. A list of knowledge graph entities to retrieve trend information
     *           for. Supported entities are tagged with
     *           [InsightsKnowledgeGraphEntityCapabilities.CONTENT_TRENDING_INSIGHTS][].
     * }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V23\Common\AudienceInsightsEntity::class);
        $this->entities = $arr;
